...
* Decentralization Day
  * Set up TorBrowser or similar(Careful to wonder around if you are faint of heart)
    ...
    * Original Anonymous Manifesto http://pdjfyv7v3pn34w4f.onion/about.html
    * Freedom Hosting, set up an anonymous blog.(Must not be linked to you) http://xqz3u5drneuzhaeo.onion/
    * Get one book you like? http://am4wuhz3zifexz5u.onion/Library/
  ...
  * Set up a ripple account https://www.youtube.com/watch?v=f9KqSgRZYgg
(Optionally compile from source after reviewing)
(Please suggest more things to decentralize ~Fabian)
