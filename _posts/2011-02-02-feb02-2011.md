...
[American national ID](http://the-classic-liberal.com/internet-national-id-card/)
...
30 minutes from each meeting (8-8:30?) allocated to a project of some kind. It can be a one night only thing, or perhaps a project that escalates over a few sessions.
Some ideas:
...
[All the crypto you need to know](http://www.bsdcan.org/2010/schedule/attachments/135_crypto1hr.pdf)
