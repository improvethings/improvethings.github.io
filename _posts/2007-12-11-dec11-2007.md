...
* **Project**: Research why does Halifax financially sustain from its [recycling](http://archive.ideasmeetings.org/wiki/recycling) program when no other city in Canada does?
* **Project**: We would like to make a hydrogen powered [blimp](http://archive.ideasmeetings.org/wiki/blimp).
